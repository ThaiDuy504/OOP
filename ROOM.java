...
public class ROOM {
    ...
    public void menu(){
        System.out.println("chon cac thao tac ban muon lam voi danh sach thiet bi.");
        boolean trangthai=true;
        declare_Devices();
        while (trangthai) {
            System.out.println("1.xem thiet bi.");
            System.out.println("2.sua thiet bi.");
            System.out.println("3.doc file");
            System.out.println("4.xuat file");
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    fixed_devices(mathietbi);
                    break;
                case 3:
                    ReadFILE("filetext.txt");
                    break;

                case 4:
                    writeFile("filetext2.txt");
                    break;
            }
        }
    }
